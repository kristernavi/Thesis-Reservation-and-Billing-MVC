...
<form:form id="clientForm" commandName="rpl"
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<c:forEach items="${roomNumber2}" var="room" varStatus="loopCounter">
											
											<div class="form-group">
										<label class="col-xs-4 control-label">Room Number: </label>
										<div class="col-xs-3" style="width: 300px;">
											<p>${room.room_no }</p>
										</div>
										<br />
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <font font="calibri" size="3"> You are sure you want to cancel? </font>
        </div>
        <div class="modal-footer">
		  <a href="${pageContext.request.contextPath}/search" class="btn btn-default" role="button" >Confirm</a>
