                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-danger-circle"></i> 			Welcome to the search reservation area wherein you can trace your room using the reference key that is given to you after your reservation transaction is done.
                        </div>
                    </div>
                </div>
				<br /> 
...
<font color="eaeaea">________________________________________________________________________________________________________________________________________________</font>
 ...
 <div class="col-lg-3">
	  ...
	  <div class="col-lg-9">
	  <form:form class="navbar-form navbar-left" commandName="reference" method="POST" action="reference.do">
	  
	   <div class="form-group">
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	  <form:input path="key" class="form-control" style="width: 330px;" />
	  
	  
       </div>
        
        <button type="submit" class="btn btn-danger">Track Status Reservation</button>
      </form:form>
				 ...
				 <div class="col-lg-6" style="width: 900px;padding-left: 400px;height: 300px;">
                        <div class="table-responsive">
                            ...
                            <table class="table table-default" border="0">
                                <thead align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<font color="red" size="2px" face="Arial"><i>${message }</i></font> <br />
                                </thead>
								<br /><br />
